...
let TicketMessage = class TicketMessage extends sequelize_typescript_1.Model {
};
...
__decorate([
    ...
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.UUID),
    __metadata("design:type", String)
], TicketMessage.prototype, "adminId", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => Ticket_1.Ticket),
...
], TicketMessage.prototype, "admin", void 0);
__decorate([
    (0, sequelize_typescript_1.AllowNull)(true),
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING),
    __metadata("design:type", String)
], TicketMessage.prototype, "image", void 0);
__decorate([
...
exports.TicketMessage = TicketMessage = __decorate([
    (0, sequelize_typescript_1.Table)({ timestamps: true, tableName: 'ticket_message' })
], TicketMessage);
