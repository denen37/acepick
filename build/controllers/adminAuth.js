...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, bcryptjs_1.hash)(password, utility_1.saltRounds, function (err, hashedPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const invite = yield Invite_1.Invite.findOne({ where: {
                    email: email
                } });
            ...
            return (0, utility_2.successResponse)(res, "Successful", { status: true,
...
const assignRole = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const admin = yield Admin_1.Admin.findOne({ where: {
            id: adminId
        } });
    if (!admin)
...
const sendInvite = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, bcryptjs_1.hash)(password, utility_1.saltRounds, function (err, hashedPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, sms_1.sendEmailResend)(email, "INVITATION TO JOIN ACEPICK ADMIN", `<p>Please click the link below to join AcePick <br><br> <strong><a href=https://admin.acepick.com/invite/${email} >JOIN ACEPICK</a></strong> <br><br> Use the code below to reset your password. <br> ${password} .</p>`);
